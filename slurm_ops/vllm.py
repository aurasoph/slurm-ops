...
# %% auto 0
__all__ = ['DEFAULT_ACCOUNT', 'DEFAULT_PARTITION', 'DEFAULT_GRES', 'DEFAULT_CPUS_PER_TASK', 'DEFAULT_MEM', 'DEFAULT_TIME', 'DEFAULT_SLURM_ARGS', 'DEFAULT_MODEL', 'DEFAULT_MAX_LEN', 'SHARED_SIF_PATH', 'make_slurm_args', 'sif_exists', 'resolve_sif', 'build_sif', 'wait_for_discovery', 'local_port_available', 'choose_local_port', 'open_ssh_forward', 'close_ssh_forward', 'vllm_up', 'vllm_down', 'vllm_chat', 'main_up', 'main_down', 'main_chat']
